...
local function loadTextFromFile(filename)
    ...
    if not content then
        logError('Îøèáêà îòêðûòèÿ òåêñòîâîãî ôàéëà: ' .. tostring(filepath) .. ', error: ' .. tostring(read_err))
...
local function renderSearchResults(full_text, query, rule_index, tab_index)
    ...
    if #results == 0 then
        imgui.TextColored(COLORS.error_soft, u8'Íè÷åãî íå íàéäåíî')
        imgui.Spacing()
        imgui.TextColored(COLORS.text_label, u8'Ïîïðîáóéòå:')
        imgui.BulletText(u8'Èñïîëüçîâàòü ñèíîíèìû')
        imgui.BulletText(u8'Ïðîâåðèòü îïå÷àòêè (àâòî-ïîèñê èñïðàâëÿåò òîëüêî ìåëêèå)')
        imgui.Spacing()
        imgui.Separator()
        imgui.Spacing()
        imgui.PushTextWrapPos(0)
    ...
    imgui.TextColored(COLORS.success, u8(string.format('Íàéäåíî: %d', #results)))
    imgui.Spacing()
    imgui.Separator()
    imgui.Spacing()
...
local function getRuleText(category, tabIndex)
    ...
    if not files then return "{FF0000}Îøèáêà: íåèçâåñòíàÿ êàòåãîðèÿ ïðàâèë" end
    if idx < 1 then idx = 1 elseif idx > #files then idx = #files end

    local filename = files[idx]
    if not filename then return "{FF0000}Îøèáêà: ôàéë íå íàéäåí" end
...
local function initStaticRules()
    fsbhelper.rulesDB = {
        ...
        {name = "Çàêîíîäàòåëüíàÿ áàçà",                                              category = "law", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        {name = "ÔÇ \"Î ñóäåáíîé ñèñòåìå è ñòàòóñå ñóäåé\"",                        category = "law", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        {name = "ÔÇ \"Î çàêðûòûõ è îõðàíÿåìûõ òåððèòîðèÿõ\"",                       category = "law", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        {name = "ÔÇ \"Î ñèñòåìå íîðìàòèâíî-ïðàâîâûõ àêòîâ Íèæåãîðîäñêîé îáëàñòè\"", category = "law", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        {name = "Óãîëîâíî-ïðîöåññóàëüíûé êîäåêñ",                                   category = "law", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        {name = "ÔÇ \"Î ïðàâîñóäèè\"",                                              category = "law", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        {name = "Òðóäîâîé êîäåêñ",                                                  category = "law", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        {name = "Åäèíàÿ ñèñòåìà ïåðåâîäîâ",                                          category = "law", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        
        {name = "Ïðàâèëà äëÿ ïîëèöåéñêèõ",                                           category = "reg", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        {name = "Ðåãëàìåíò ïðîâåäåíèÿ ïðîâåðîê",                                     category = "reg", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        {name = "Êðèòåðèè äëÿ âñòóïëåíèÿ âî ôðàêöèè",                               category = "reg", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        {name = "Óñòàâíîé âíåøíèé âèä",                                             category = "reg", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        {name = "Ñòðóêòóðà ãîñóäàðñòâåííûõ ôðàêöèé",                                category = "reg", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        {name = "Ñèñòåìà âûáîðîâ ãóáåðíàòîðà",                                       category = "reg", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        {name = "Ãðàôèê ðàáî÷åãî äíÿ",                                              category = "reg", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        {name = "Ïðàâèëà ãîñóäàðñòâåííîé âîëíû",                                    category = "reg", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        
        {name = "ÔÑÁ | Óñòàâ",                                                      category = "fsb", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        {name = "ÔÑÁ | Ïðàâèëà âíåäðåíèÿ",                                          category = "fsb", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        
        {name = "ÌÂÄ | Ñïðàâî÷íèê Ñîòðóäíèêà",                                      category = "mvd", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        {name = "ÌÂÄ | Ïðàâèëà ñòðîåâîãî óñòàâà",                                   category = "mvd", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
        {name = "ÌÂÄ | Óñòàâ",                                                      category = "mvd", updateDate = "30.04.2026", key = {}, keyName = "Íå íàçíà÷åíî", holdMode = false, extra_h = -9},
    }
end
